...
#define COLOR_BTN_COMMON    lv_color_make(225,225,225)
...
static void style_init(my_theme_t * theme)
{
    ...
    style_init_reset(&theme->styles.btn_common);
    lv_style_set_bg_opa(&theme->styles.btn_common, LV_OPA_COVER);
    lv_style_set_bg_color(&theme->styles.btn_common, COLOR_BTN_COMMON);
}
